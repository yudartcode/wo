        ...
        <div class="nav-header">
            @foreach ($web as $data)
                <a href="{{ route('dashboard.index') }}" class="brand-logo">
                    <img class="logo-abbr"
                        src="{{ isset($data) ? asset('profile/' . $data->logo) : asset('default-image.png') }}"
                        style="width: 200px !important;">
                    <img class="logo-compact" src="{{ asset('images/logo-text.png') }}" alt="">
                    <span class="brand-title"
                        style="font-size:12px;font-weight: bold; color: rgb(150, 155, 160);">{{ $data->name }}</span>
                </a>
            @endforeach
                        ...
                        <ul class="navbar-nav header-right">
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                    ...
                                    @else
                                        <img src="{{ asset('images/admin_component/admin.png') }}" width="20"
        ...
        <div class="deznav">
            <div class="deznav-scroll mm-active">
                <ul class="metismenu mm-show" id="menu">
                    <li
                        class="
								@if (request()->routeIs('dashboard.index') || request()->routeIs('dashboard.create')) 'mm-active'
								@else
								'' @endif
						">
                    ...
                    <li class="{{ request()->routeIs('manajemen-akun.index') ? 'mm-active' : '' }}">
                        ...
                        <ul aria-expanded="false" class="mm-collapse" style="">
                            <li class="{{ request()->routeIs('manajemen-akun-admin.index') ? 'mm-active' : '' }}"><a
                                    href="{{ route('manajemen-akun-admin.index') }}">Admin</a></li>
                            <li class="{{ request()->routeIs('manajemen-akun.index') ? 'mm-active' : '' }}"><a
                                    href="{{ route('manajemen-akun.index') }}">User</a></li>
                        </ul>
                    </li>
