...
@section('content')
    ...
    <main>
        <section class="cart section">
            <div class="container">
                @if ($bayar->status_pembayaran == 'sudah')
                    <h3>Pesanan anda telah terbayar</h3>
                @else
                    <h3>Pesanan anda telah masuk ke database kami</h3>
                    <p style="margin-top: 10px;">Harap bayar pesanan anda melalui rekening dibawah ini:</p>
                    <br><br>
                    ...
                    <table>
                        <tr>
                            <td style="width: 300px">
                                <div>
                                    <img src="{{ asset('images/profile/BNI_logo.png') }}" style="width: 200px"
                                        alt="">
                                    <p>BNI : 1177226632</p>
                                    <p>A/n : Nama Bisnis</p>
                                </div>
                            ...
                            <td>
                                <div>
                                    <img src="{{ asset('images/profile/BRI_logo.png') }}" style="width: 180px"
                                        alt="">
                                    <p>BRI : 01293136182382</p>
                                    <p>A/n : Nama Bisnis</p>
                                </div>
                            </td>
                        </tr>
                    ...
                    <p>Kemudian melakukan konfirmasi ke whatsapp terlebih dahulu sebelum memesan paket yang lain.</p>
                    ...
                    <div class="d-flex" style="margin-top: 20px;">
                        ...
                        @endforeach
                        @if (count($web) < 1)
                            <a class="btn" href="https://wa.me/6285156574497">+6285156574497</a>
                        @endif

                    </div>
                    <br><br>Atau
                    <br><br>
                    <button type="button" class="btn" style="font-size: 15px" id="bayarPaket"
                        onclick="batalPesanan()"><i class="fas fa-do-not-enter" style="margin-right: 10px;"></i> Batalkan
                        Pesanan</button>
                @endif
            </div>
        </section>
